...
$(function(){
    function dangqian(){
        ...
        $(".v_item").each(function(i){
            if($(this).hasClass("rank")){
                ...
                $(".v_item").eq(v_index).addClass("cur").css("marginRight",12+'rem');
                $(".vip_info dl").eq(v_index).show().siblings().hide();
                $(".v_ac").css("left",-(v_index*7.55)+'rem');
                $(".vip_rate_big").show();
                $(".vip_rate_small").css("left",(v_index*7.55)+'rem');
                $(".vip_rate_small").hide();
                dclick=$(this).index();
                if(v_index==12){
                    ...
                    $(".upgrade").hide();
                    $(".v_ac").css("left",-((v_index-1)*7.55)+'rem');
                }
                else if(v_index==0){
    ...
    $(".v_item").click(function(){
            ...
            var v_width=Number(v_w)+Number(v_mright); //距离换算修正
            if($(this).offset().left>offset_jizhun){//点击屏幕右侧
            ...
            else if($(this).offset().left<offset_jizhun){//点击屏幕左侧
